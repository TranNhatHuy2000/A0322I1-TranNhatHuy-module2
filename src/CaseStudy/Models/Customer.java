...
public class Customer extends Person {
    ...
    public Customer(String fullName, String dateOfBirth, String gender, int idNumber, int phone, String email, int idCustomer, String typeCustomer, String address) {
